...
<br/><br/><img src="https://progress-bar.dev/47/?scale=89&title=%20Completed%20&width=415&suffix=%20%2F%2089%20Pages">
...
- [Linear Rails](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_0/linear_rails.md) - Smooth operation is not optional
- [Base Plate Screws](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_0/bed_plate.md) - How tight is too tight?
...
- 🙂 [Drop-in HotEnd Replacements](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_2/hotends.md) - A quick way to get more performance from your printer
...
- [2D Print Transfers](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_e/transfers.md) - Add full-color 2D images to the first layer of your 3D prints.
- [Recycling Printer Waste](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_e/recycling.md) - From support material to failed prints to calibrations, what to do about waste
...
<!--CLOC-START -->
```
Last updated at 2024-08-03 12:41:58 UTC
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
Markdown                        90            406              2           1457
YAML                             1              8             13             33
