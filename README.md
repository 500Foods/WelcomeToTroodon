...
- [CANCEL_PRINT](https://github.com/500Foods/WelcomeToTroodon/blob/main/macros/CANCEL_PRINT.md) - Runs whenever a new print job is canceled, manually or otherwise
