...
<br/><img src="https://progress-bar.dev/53/?title=%20Completed%20&width=415">
...
- LIGHTS_TOGGLE - Turn the main chamber light on or off via a macro or a KlipperScreen button
...
- [Recycling Printer Waste](https://github.com/500Foods/WelcomeToTroodon/blob/main/docs/level_e/recycling.md) - From support material to failed prints to calibrations, what do do about waste
...
<!--CLOC-START -->
```
Last updated at 2024-06-23 01:27:41 UTC
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
Markdown                        86            349              2           1240
YAML                             1              8             13             33
